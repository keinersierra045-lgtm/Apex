/* ================================================================
   ...
   volver a tocar el HTML base. La apertura/cierre (antes lógica
   propia) ahora se delega en APEX.uiPanel, compartida con
   favorites.js y menu.js. Se registra en window.APEX.cart.
================================================================ */
...
(() => {
  ...
  let drawerEl = null;
  let drawerPanel = null; // controlador de APEX.uiPanel
  ...
  function bindEvents() {
    ...
    drawerEl.querySelector('.cart-drawer__close').addEventListener('click', drawerPanel.close);
    ...
    // products.js / search.js / favorites.js emiten este evento al
  ...
  function init() {
    ...
    drawerPanel = window.APEX.uiPanel.create({
      panel: drawerEl,
      overlay: $('#overlay'),
      // El carrito no tiene un botón "toggle" único con estado
      // (aria-expanded no aplica a un icono de carrito como sí
      // aplica al menú), así que se omite toggleBtn: el drawer se
      // abre desde el icono del header y se cierra desde su propio
      // botón "×", overlay o Escape.
      lockScroll: true,
